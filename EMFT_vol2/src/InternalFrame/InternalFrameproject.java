...
public class InternalFrameproject extends javax.swing.JInternalFrame {
    ...
    private int progress_bar_current_cycle;
    ...
    private void initComponents() {
        ...
        calcBaE_poyting.setBackground(new java.awt.Color(255, 51, 51));
        calcBaE_poyting.setText("Poyting");
        calcBaE_poyting.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                calcBaE_poytingActionPerformed(evt);
            }
        });
        ...
        try {
            ...
            if (sulana == true) {
                ...
                for (int cl0 = 0; cl0 < observerPanel1.Table.getSelectedRowCount(); cl0++) {
                    ...
                    if (observerPanel1.P1D_par.isSelected() == true) {
                        calculate_E_old_plus_parameter(BEplus, cl0);
                    }
...
//                graf3.draw_2D_yn(); 
    ...
    private void calc_MATRIXActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_calc_MATRIXActionPerformed
        ...
        if (main_Jframe.iscalculationELPAM_Settings == false) {
            ...
            for (int cl01 = 0; cl01 < pocetCyklovparametrov; cl01++) {
                ...
                calculatecatenaryParameter_ELPAM_parameter(selectedIndex, krokVal * cl01, odVal); // neupravuje hodnoty elpam
                aproxx = priprava_vektorov(elementh, aproxx);

                vektor_observerov_ELPAM[cl01] = calculateELPAM(calculationELPAM_Settings.getmetoda(),
    ...
    private void calcBaE_poytingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_calcBaE_poytingActionPerformed
        ...
        if (main_Jframe.iscalculation_Settings == false) {
            String[] args = null;
            calculation_Settings.main(args);
            main_Jframe.iscalculation_Settings = true;
        }else {
        
         UplusPhi = help.ReadCheckDouble(calculation_Settings.getPhisUplus(),0) ;
         IplusPhi = help.ReadCheckDouble(calculation_Settings.getPhiIplus(),0) ;
          boolean poyting=true;
        ...
        try {
            ...
            if (sulana == true) {
                ...
                BE.clear(); // predkaždym startom sa databaza vyčisti
                BEplus.clear(); // predkaždym startom sa databaza vyčisti
                Rozpätie.calculateTau_OLD(aproxx, UplusPhi);
                for (int cl0 = 0; cl0 < observerPanel1.Table.getSelectedRowCount(); cl0++) {
        ...
        UplusPhi =0; //vynulovanie faz
        IplusPhi =0;
    }//GEN-LAST:event_calcBaE_poytingActionPerformed
    ...
    private Observer calculateELPAM(int metoda, boolean bundle, boolean aproxx, boolean exactGMR, boolean exactRAC, boolean makeTxt, boolean parametrical) {
        ...
        try {
            ...
            if (method == 1) {
                ...
                for (int element = 0; element < number_of_elements; element++) {
                    ...
                    progress_bar_value++;
                    double value = (( (double) progress_bar_value) / ((double) 2 * (double) number_of_elements * (double) progress_bar_cycles)) * 100; //2 iteratory no n.o.e
                    if (value % 5 == 0) {
                        updatePB((int) value);
                    }
                }
...
//                     }
    ...
    /**
     * nahodi parametre do vodiča a priprave vsetko napparametrizaciu pre dany
     * krok poradie j pre subor conductor.txt kde su ulozene parametre
     * setElpam_D setElpam_T; setElpam_rho_cnd; setElpam_rho_gnd; setElpam_Rdc;
     * setElpam_Al_layers; setElpam_Al_start; setElpam_Al_d;
     */
    public void calculatecatenaryParameter_ELPAM_parameter(int Stlpec, double hodnota, double start) {
        ...
        if (idemePocitat == true) {
            ...
            for (int i = 0; i < rows - 1; i++) {
                ...
                String porovnavacka = String.valueOf(catenaryPanel1.DTMTable.getValueAt(i, 22));
                int index = 0;
                for (int j = 0; j < catenaryPanel1.getConductor_Name_Matrix().size(); j++) {

                    if (porovnavacka.equals(catenaryPanel1.getConductor_Name_Matrix().get(j))) {
                        index = j;
                    }
                }
                ...
                if (isChecked == true) { // iba ak je zasškrtnute tak vklada lana
                    ...
                    double valF = constants.getFrequency();

                    double valT = catenaryPanel1.getConductor_parameters_Matrix().get(index)[1];
                    double valrho_cnd = catenaryPanel1.getConductor_parameters_Matrix().get(index)[2];
                    double valrho_gnd = catenaryPanel1.getConductor_parameters_Matrix().get(index)[3];
                    double valRdc = catenaryPanel1.getConductor_parameters_Matrix().get(index)[4];
                    double valAl_layers = catenaryPanel1.getConductor_parameters_Matrix().get(index)[4];
                    double valAl_start = catenaryPanel1.getConductor_parameters_Matrix().get(index)[6];
                    double valAl_d = catenaryPanel1.getConductor_parameters_Matrix().get(index)[7];
                    ...
                    if (isCheckedpar == true && observerPanel1.P1D_par_A.isSelected() == true) {
                        ...
                        if (Stlpec == 19) {
                            valrho_cnd = start + hodnota;
                        }
                        if (Stlpec == 20) {
                            valrho_gnd = start + hodnota;
                        }
                        if (Stlpec == 21) {
                            valRdc = start + hodnota;
                        }
                        if (Stlpec == 22) {
                            valAl_layers = start + hodnota;
                        }
                        if (Stlpec == 23) {
                            valAl_start = start + hodnota;
                        }
                        if (Stlpec == 24) {
                            valAl_d = start + hodnota;
                        }
                    }
                    ...
                    if (isCheckedpar == true && observerPanel1.P1D_par_B.isSelected() == true) {
                        ...
                        if (Stlpec == 19) {
                            valrho_cnd = valrho_cnd + hodnota;
                        }
                        if (Stlpec == 20) {
                            valrho_gnd = valrho_gnd + hodnota;
                        }
                        if (Stlpec == 21) {
                            valRdc = valRdc + hodnota;
                        }
                        if (Stlpec == 22) {
                            valAl_layers = valAl_layers + hodnota;
                        }
                        if (Stlpec == 23) {
                            valAl_start = valAl_start + hodnota;
                        }
                        if (Stlpec == 24) {
                            valAl_d = valAl_d + hodnota;
                        }
                    }
                    ...
                    try {
                        ...
                        lano.setElpam_f(valF);
                        lano.setElpam_D(val13 * 2); // priemer lana 
                        lano.setElpam_T(valT);
                        lano.setElpam_rho_cnd(valrho_cnd);
                        lano.setElpam_rho_gnd(valrho_gnd);
                        lano.setElpam_Rdc(valRdc);
                        lano.setElpam_Al_layers((int) valAl_layers);
                        lano.setElpam_Al_start((int) valAl_start);
                        lano.setElpam_Al_d(valAl_d);
    ...
    /**
     * funkcia ktory pripravy vektory casto sa opakujuci krok
     *
     * @param elementh dlzka elementu
     * @param aproxx aproxx povoleny alebo nie
     */
    private boolean priprava_vektorov(double elementh, boolean aproxx) {
    ...
    private void calculateELPAM_induced(int metoda, boolean aproxx, boolean exactGMR, boolean exactRAC) {
        try {
            ...
            int bundle_counter = 1;
            for (int i = 0; i < pocet_vodicov; i++) {
                elpam_input_conductor cnd2add = new elpam_input_conductor(); //treba vzdy definovat nanovo nech neprepisuje ArrayList!!!!!!!!!!!!
                bundle_counter = Rozpätie.getRetazovkaList().get(i).getBundle_over();
                for (int j = 0; j < bundle_counter; j++) {
                    Rozpätie.getRetazovkaList().get(i).calcGMR_Rac_xi();
                    cnd2add.setF(constants.getFrequency());
                    cnd2add.setD(Rozpätie.getRetazovkaList().get(i).getElpam_D());
                    cnd2add.setT(Rozpätie.getRetazovkaList().get(i).getElpam_T());
             ...
             */
            int method = metoda;
            String type = "phase"; //pre indukovany vzdy len fazovo


            //ArrLists for Impedance - phase matrices
            //ComplexMatrices for Impedance - phase matrices
            if (method == 1) {
                ArrayList<ComplexMatrix> Z_total_Carson_no_gnd = new ArrayList<>();
                ComplexMatrix Z_total_Carson_no_gnd_final = new ComplexMatrix(lan, lan);
                ...
                for (int element = 0; element < number_of_elements; element++) {
                    ...
                    //compute all parameters
                    test_carson.calcZ_no_gnd();
                    
                    //store to ArrayList
                    Z_total_Carson_no_gnd.add(test_carson.getZ_no_gnd());
                ...
                //make average parameters from ArrayLists
                ComplexMatrix cSum_Carson_no_gnd = new ComplexMatrix(lan, lan);
                ...
                //induced currents
                Rozpätie.addZ_induced(Z_total_Carson_no_gnd_final);

            } else if (method == 2) {
                ArrayList<ComplexMatrix> Z_total_Carson_gnd = new ArrayList<>();
                ComplexMatrix Z_total_Carson_gnd_final = new ComplexMatrix(lan, lan);
                ...
                for (int element = 0; element < number_of_elements; element++) {
                    ...
                    //compute all parameters
                    test_carson.calcZ_gnd();
                    
                    //store to ArrayLists
                    Z_total_Carson_gnd.add(test_carson.getZ_gnd());
                ...
                //make average parameters from ArrayLists
                ComplexMatrix cSum_Carson_gnd = new ComplexMatrix(lan, lan);
                ...
                //induced currents
                Rozpätie.addZ_induced(Z_total_Carson_gnd_final);
 

            } else if (method == 3) {
                ArrayList<ComplexMatrix> Z_total_Carson_mod_no_gnd = new ArrayList<>();
                ComplexMatrix Z_total_Carson_mod_no_gnd_final = new ComplexMatrix(lan, lan);
                ...
                for (int element = 0; element < number_of_elements; element++) {
                    ...
                    //compute all parameters
                    test_carson_mod.calcZ_no_gnd();
                    
                    //store to ArrayLists
                    Z_total_Carson_mod_no_gnd.add(test_carson_mod.getZ_no_gnd());
                ...
                //make average parameters from ArrayLists
                ComplexMatrix cSum_Carson_mod_no_gnd = new ComplexMatrix(lan, lan);
                ...
                //induced currents
                Rozpätie.addZ_induced(Z_total_Carson_mod_no_gnd_final);

            } else if (method == 4) {
                ArrayList<ComplexMatrix> Z_total_Carson_mod_gnd = new ArrayList<>();
                ComplexMatrix Z_total_Carson_mod_gnd_final = new ComplexMatrix(lan, lan);
                ...
                for (int element = 0; element < number_of_elements; element++) {
                    ...
                    //compute all parameters
                    test_carson_mod.calcZ_gnd();
                    
                    //store to ArrayLists
                    Z_total_Carson_mod_gnd.add(test_carson_mod.getZ_gnd());
                ...
                //make average parameters from ArrayLists
                ComplexMatrix cSum_Carson_mod_gnd = new ComplexMatrix(lan, lan);
                ...
                //induced currents
                Rozpätie.addZ_induced(Z_total_Carson_mod_gnd_final);

            } else if (method == 5) {
                ArrayList<ComplexMatrix> Z_total_Basic = new ArrayList<>();
                ComplexMatrix Z_total_Basic_final = new ComplexMatrix(lan, lan);
                ...
                for (int element = 0; element < number_of_elements; element++) {
                    ...
                    //store to ArrayLists
                    Z_total_Basic.add(test_basic.getZ());
                ...
                //make average parameters from ArrayLists
                ComplexMatrix cSum_Basic = new ComplexMatrix(lan, lan);
                ...
                //induced currents
                Rozpätie.addZ_induced(Z_total_Basic_final);

            } else if (method == 6) {
                ArrayList<ComplexMatrix> Z_total_CDER = new ArrayList<>();
                ComplexMatrix Z_total_CDER_final = new ComplexMatrix(lan, lan);
                ...
                for (int element = 0; element < number_of_elements; element++) {
                    ...
                    //store to ArrayLists
                    Z_total_CDER.add(cder_test.getZ());
                ...
                //make average parameters from ArrayLists
                ComplexMatrix cSum_CDER = new ComplexMatrix(lan, lan);
                ...
                //induced currents
                Rozpätie.addZ_induced(Z_total_CDER_final);

            } else if (method == 7) {
                ArrayList<ComplexMatrix> Z_total_TakuNoda = new ArrayList<>();
                ComplexMatrix Z_total_TakuNoda_final = new ComplexMatrix(lan, lan);
                ...
                for (int element = 0; element < number_of_elements; element++) {
                    ...
                    //store to ArrayLists
                    Z_total_TakuNoda.add(tn_test.getZ());
                ...
                //make average parameters from ArrayLists
                ComplexMatrix cSum_TakuNoda = new ComplexMatrix(lan, lan);
                ...
                //induced currents
                Rozpätie.addZ_induced(Z_total_TakuNoda_final);
            }
            updatePB(100);
        } catch (DelaunayError ex) {
            Logger.getLogger(InternalFrameproject.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private javax.swing.JButton calcBaE_poyting;
    ...
    private double UplusPhi = 0; // pridavne fazy pre poyting vektor
    private double IplusPhi = 0; // pridavne fazy pre poytin g vektor
