...
import InternalFrame.CatenaryPanel;
 ...
 *
 * @author Jozef
 * vytvory retazovku a vypočita všetky potrebne parametre
 * tri možne construktory
 *  vsetky hodnoty
 *  Dpoint
 *  konštruktor ktory našitava Z Rozpatie hodnotu ( služi na prepočet parametrov retazovky
 *  zaroven sa vypočitavaju konštanty pre bundle bvodiš.. tieto hodnoty preby pripočitať ku poloham vodiča pre dany cyklus
 * 
 */
public class retazovka {
    ...
    X1_over = X1; X2_over = X2; distance_over=distance; CorH_over=CorH;
    ...
    I1_over=I1;I2_over=I1;bundle_over=bundle;alpha_over=alpha; distance_over=distance;
    HC_over=HC;r_over=r;U_over=U;I_over=I;Phi_over=Phi; terenTriangles_over =  terenTriangles; CorH_over=CorH;
   ...
   generateBundleConstants();
    ...
    I1_over=R.getI1_over();I2_over=R.getI2_over();bundle_over=R.getBundle_over();alpha_over=R.getAlpha_over(); distance_over=R.getDistance_over();
    HC_over=R.getHC_over();r_over=R.getR_over();U_over=R.getU_over();I_over=R.getI_over();Phi_over=R.getPhi_over(); terenTriangles_over =  terenTriangles2; CorH_over=R.isCorH_over();
        
    P1_over = new DPoint(0, 0, 0);
    P2_over = new DPoint(0, 0, 0);
    P1_over=R.getP1_over(); P2_over=R.getP2_over();
   ...
   if(bundle_over != 1){
    ...
    /**
     *  funkcia ktory na iteračneho kroku a vypocitanich parametrov retazovky vypočíta polohu vektora R0 na koniec elementu
...
/**
 * funkcia ktory na iteračneho kroku a vypocitanich parametrov retazovky vypočíta polohu vektora R0 navybrau cast elementu
 * @param cl1 iteračny krok
 * @param elementLength dlžka elementu
 ...
 */    
      public DPoint get_R0_vector(int cl1,double elementLength,String position ) throws DelaunayError{
        ...
        if (position.equals("END")) pozicna_konstanta= 0; // koniec elementu lana
        if (position.equals("MIDDLE")) pozicna_konstanta= 0.5;     // stred elementu lana
        if (position.equals("BEGIN")) pozicna_konstanta= 1; // začiatok elementu lana
